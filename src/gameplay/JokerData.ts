...
export const MVP_JOKERS: JokerDefinition[] = [
  ...
  },
  {
    id: 'blackboard',
    name: 'Blackboard',
    description: '+15 Mult if all played cards are ♠ or ♣',
    cost: 7,
    rarity: 2,
    effect: { trigger: JokerTrigger.OnHandScored, condition: 'all_black', chips: 0, mult: 15, isXMult: false, gold: 0 },
  },
  {
    id: 'crazy_joker',
    name: 'Crazy Joker',
    description: '+12 Mult if hand is a Straight or a Flush',
    cost: 6,
    rarity: 2,
    effect: { trigger: JokerTrigger.OnHandScored, condition: 'hand=straight_or_flush', chips: 0, mult: 12, isXMult: false, gold: 0 },
  },
  {
    id: 'droll_joker',
    name: 'Droll Joker',
    description: '+10 Mult if you played exactly 5 cards',
    cost: 6,
    rarity: 1,
    effect: { trigger: JokerTrigger.OnHandScored, condition: 'hand=5cards', chips: 0, mult: 10, isXMult: false, gold: 0 },
  },
  {
    id: 'ramen',
    name: 'Ramen',
    description: '+20 Mult, loses 3 Mult per discard',
    cost: 7,
    rarity: 2,
    effect: { trigger: JokerTrigger.OnDiscard, condition: 'always', chips: 0, mult: -3, isXMult: false, gold: 0 },
  },
  {
    id: 'matador',
    name: 'Matador',
    description: '+2 Mult for each hand played this round',
    cost: 6,
    rarity: 1,
    effect: { trigger: JokerTrigger.OnHandScored, condition: 'per_hand_this_round', chips: 0, mult: 2, isXMult: false, gold: 0 },
  },
  {
    id: 'trading_card',
    name: 'Trading Card',
    description: 'When you discard, gain $1',
    cost: 6,
    rarity: 2,
    effect: { trigger: JokerTrigger.OnDiscard, condition: 'always', chips: 0, mult: 0, isXMult: false, gold: 1 },
  },
  {
    id: 'stone_joker',
    name: 'Stone Joker',
    description: '+25 Chips if played hand contains a Stone card',
    cost: 6,
    rarity: 2,
    effect: { trigger: JokerTrigger.OnHandScored, condition: 'has_stone', chips: 25, mult: 0, isXMult: false, gold: 0 },
  },
  {
    id: 'glass_joker',
    name: 'Glass Joker',
    description: '+2 Mult for each Glass card in played hand',
    cost: 6,
    rarity: 2,
    effect: { trigger: JokerTrigger.OnCardScored, condition: 'is_glass', chips: 0, mult: 2, isXMult: false, gold: 0 },
  },
];
